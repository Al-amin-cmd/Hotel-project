...
if(isset($_POST["submit"]))
{
	...
	if($error == '')
	{
		...
		$mail->Port       = 587;             
		$mail->AddAddress('alaminkhoksa686@gmail.com');//add your email address
		$mail->Username='alaminkhoksa686@gmail.com';  //add your email address
		$mail->Password='kbcaetxxfsftoqqj';  //add your email pass
